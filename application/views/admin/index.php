                      ...
                      <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                          <div class="">
                            ...
                            <span class="fs-18 font-w500 d-block">Total Presence</span>
                          </div>
                        </div>
                        <img src="<?= base_url('assets/template/images/presence.png') ?>" alt="student" width="80">
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6 col-sm-6">
                      ...
                      <div class="card-body d-flex px-4  justify-content-between">
                        <div>
                          <div class="">
                            ...
                            <span class="fs-18 font-w500 d-block">Total Theory</span>

                          </div>
                        </div>
                        <img src="<?= base_url('assets/template/images/education.png') ?>" alt="student" width="80">
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-6 col-sm-6">
