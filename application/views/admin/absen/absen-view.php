      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="" method="post">
            ...
            <div class="mb-3">
              <label class="form-label">Jam Toleransi</label>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="<?= base_url('admin/updateAbsen/') ?>" method="post">
              ...
              <div class="mb-3">
                <label class="form-label">Jam Toleransi</label>
                <input type="time" class="form-control" name="toleransi" value="<?= $a['jam_toleransi'] ?>">
                <?= form_error('toleransi', '<small class="text-danger pl-3">', '</small>'); ?>
              </div>
          </div>
          <div class="modal-footer">
            <button type="submit" class="btn btn-primary">Save</button>
